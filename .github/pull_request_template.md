...
<!-- Branch flow: develop → main (main accepts PRs from develop only). PR title follows Conventional Commits (feat:, fix:, build:, ci:, docs:, chore:, …). -->
...
- [ ] `PR source`, `Lint`, and `Image tests` are green
